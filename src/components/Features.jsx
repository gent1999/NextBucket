  ...
  return (
    ...
    <div className="h-1 bg-gradient-to-r from-orange-500 to-transparent w-48 mx-auto mb-12 rounded-full" />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12 max-w-5xl mx-auto">
        <div>
          <UserCircle size={48} className="mx-auto mb-4 text-orange-500" />
        ...
        <div>
          <Map size={48} className="mx-auto mb-4 text-orange-500" />
        ...
        <div>
          <Flame size={48} className="mx-auto mb-4 text-orange-500" />
        ...
        <div>
          <BadgeCheck size={48} className="mx-auto mb-4 text-orange-500" />
        ...
        <div>
          <Search size={48} className="mx-auto mb-4 text-orange-500" />
